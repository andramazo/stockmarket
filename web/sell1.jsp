...
<form action="sell.jsp" method="post" name="f1">
<table class="style1" cellpadding="3" cellspacing="2">
<tr><td>Company name</td>
<td style="width: 182px">
    
<input name="cm" type="text" style="width: 180px" /> 
   
 </td>
</tr>

          <tr><form action="sell.jsp" method="post"><td><input name="Submit1" type="submit" value="Buy Share" style="width: 72px" /></td>
