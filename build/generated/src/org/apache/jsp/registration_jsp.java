 ...
 String bal,dam,pas,unam,rpass,sque,ans,fname,lname,gname,gfname,day,month,year,mno,email,lno,gender,natlity,add,pcode,city,state,qua,mstatus,acc,bname,bcity,bstate,pan; 
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar ans = document.getElementById('ans');\n");
      out.write("\tvar fnm = document.getElementById('fnm');\n");
      out.write("\tvar lnm = document.getElementById('lnm');\n");
      out.write("\tvar fn = document.getElementById('fn');\n");
      out.write("\tvar ln = document.getElementById('ln');\n");
      out.write("\n");
      out.write("\n");
      out.write("\t// Check each input in the order that it appears in the form!\n");
      out.write("\tif(isAlphanumeric(uname, \"Please enter only letters and numbers for your name\")){\n");
      out.write("\t\tif(isAlphanumeric(ans, \"Numbers and Letters Only for Address\")){\n");
      out.write("\t\t\tif(isAlphabet(fnm, \"Please enter only letters\")){\n");
      out.write(" \t\t\t\t\tif(isAlphabet(lnm, \"Please enter only letters\")){\n");
      out.write("\t\t\t\t\t\t\tif(isAlphabet(fn, \"Please enter only letters\")){\n");
      out.write("\t\t\t\t\t\t\t\tif(isAlphabet(ln, \"Please enter only letters\")){\n");
      out.write("\n");
      out.write("\t\t\t\tif(madeSelection(state, \"Please Choose a State\")){\n");
      out.write("\t\t\t\t\tif(lengthRestriction(username, 6, 8)){\n");
      out.write("\t\t\t\t\t\tif(emailValidator(email, \"Please enter a valid email address\")){\n");
      ...
      out.write("    <form name=\"form2\" method=\"post\" action=\"registration.jsp\">\n");
      ...
      out.write("                    <td colspan=\"3\" style=\"height: 29px\">&nbsp;<select name=\"sta\">\n");
      out.write("\t\t\t\t\t\t<option id=\"j0\">What is my First School Name?</option>\n");
      out.write("\t\t\t\t\t\t<option id=\"aj0\">Who is my best friend?</option>\n");
      out.write("\t\t\t\t\t\t<option id=\"net0\">What is my mobile no?</option>\n");
      out.write("\t\t\t\t\t\t<option id=\"php0\">What is your favourite chat?</option>\t\t\n");
      out.write("                                                <option id=\"phpq0\">What is your favourite color?</option>\t\t\n");
      ...
      out.write(" \t\t\t\t <option value=\"\" selected=\"\" name=\"date\">Day</option>  \t\t                                            <option value=\"01\">01</option>\n");
      ...
      out.write("            <td style=\"width: 125px; height: 7px; color: #0066FF; font-family: 'Monotype Corsiva'; font-size: medium; font-weight: bold; background-color: #FFFFFF;\">&nbsp;<input type=\"submit\" value=\"Submit\" onclick=\"formValidator\"/></td>\n");
