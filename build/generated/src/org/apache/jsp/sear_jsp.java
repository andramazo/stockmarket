    ...
    try {
      ...
      out.write("        ");
            ...
            try{
                ...
                String com=""+session.getAttribute("cname");
                
                com="DLF";
                rs=smnt.executeQuery("select ID,Code,Symbol,Prev,Open,Last,High,Low,Vol from StockWatchlist where Symbol like '%"+com+"%'");
